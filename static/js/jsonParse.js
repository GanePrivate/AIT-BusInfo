...
function getTodayTimetable() {
    ...
    */
    ...
    // const T2_toDaigaku_json = '{"0":null,"1":null,"2":null,"3":null,"4":null,"5":null,"6":null,"7":null,"8":[0,10,20,30,40,50],"9":[0,10,20,30,40,55],"10":[5,15,25,35,55],"11":[15,35,55],"12":[15,35,55],"13":[20,50],"14":[15,35,55],"15":[5,15,35,45],"16":[5,15,30,45],"17":[0,10,45],"18":[5,35,45],"19":[15,35,45],"20":[25,30],"21":[5],"22":null,"23":null}';
    // const T2_toYakusa_json = '{"0":null,"1":null,"2":null,"3":null,"4":null,"5":null,"6":null,"7":null,"8":[20,50],"9":[20],"10":[50],"11":[10,30,50],"12":[10,30,50],"13":[15,45],"14":[10,30,45,50,55],"15":[10,20,40,50],"16":[0,10,20,25,35,45,55],"17":[0,5,25,30,35,45,55],"18":[0,20,25,40,50],"19":[0,20,30,50],"20":[0,15,40],"21":[0,15,30],"22":null,"23":null}';
    ...
    // const T2_toDaigaku = JSON.parse(T2_toDaigaku_json);
    // const T2_toYakusa = JSON.parse(T2_toYakusa_json);
    ...
    switch (daiya) {
        ...
        // case "T2":
        //     toDaigaku = T2_toDaigaku;
        //     toYakusa = T2_toYakusa;
        //     toDaigakuFirst = 0;
        //     toYakusaFirst = 20;
        //     break;
    }
...
function getAfterNextMin(flag, timeTable, hour, hour2) {
    ...
    */
    ...
    if (!flag) {
        var result = getNearVal(timeTable[hour], mode = 3);
        if (result == -1) {
            result = getNearVal(timeTable[hour + 1], mode = 1);
            hour2 += 1;
        }
    } else {
        var result = getNearVal(timeTable[hour + 1], mode = 3, reset = true);
        hour2 += 1;
        if (result == -1) {
...
function main() {
    ...
    // document.getElementById("T2_toDaigaku").style.display = "none";
    // document.getElementById("T2_toYakusa").style.display = "none";
